...
* Amazon Web Services Simple Storage Services (S3) using :class:`S3.Client` (i.e., ``s3`` scheme)
* Amazon Web Services Simple Notification Service (SNS) using :class:`SNS.Client` (i.e., ``sns`` scheme)
